...
require 'shoulda'
    ...
    f = {
:line_number => 1 , :item_number => "105350", :description => "AMANA ELEC DRYER WHITE", :quantity => 1, :unit_price => 374.79
    } 
...
describe LineItem, type: :model do
    ...
    include Shoulda::Matchers::ActiveRecord
        ...
        it 'validates them' do
            subject {LineItem.new f[:line_number], f[:item_number], f[:description], f[:quantity], f[:unit_price]}
            should validate_presence_of(:line_number)
        end
    end
end